	...
	return (
		<div className="help-and-documentation">
			...
			<section className="section">
				...
				<ol>
					<li className="cards__item__text">Navigate to the "Diets" tab in the app.</li>
			...
			<section className="section">
				...
				<ol>
					<li className="cards__item__text">Go to the "Workouts" section in the app.</li>
			...
			<section className="section">
				...
				<ol>
					<li className="cards__item__text">Visit the "Communities" page.</li>
			...
			<section className="section">
				...
				<p className="cards__item__text">If you need further assistance or have any questions, feel free to contact our support team at support@freakingfit.com.</p>
			</section>
		</div>
	);
};

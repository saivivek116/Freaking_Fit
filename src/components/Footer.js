			...
			<div className="vertical-footer">
				...
				<div className="footer-column">
					...
					<ul className="nav-list social-media">
						<li className="nav-item">
							<Link to="https://facebook.com" className="footer-link">
								<FontAwesomeIcon icon={faFacebook} />
							</Link>
						</li>
						<li className="nav-item">
							<Link to="https://twitter.com" className="footer-link">
								<FontAwesomeIcon icon={faTwitter} />
							</Link>
						</li>
						<li className="nav-item">
							<Link to="https://instagram.com" className="footer-link">
